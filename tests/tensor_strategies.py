...
import tinytorch
from tinytorch import Tensor, TensorBackend, TensorData, UserIndex, UserShape
...
@composite
def shapes(draw: DrawFn) -> tinytorch.UserShape:
...
def tensors(
    ...
    backend = tinytorch.SimpleBackend if backend is None else backend
